...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionDefaultTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Default Creation Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionBoundsTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Bounds Creation Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FBoxSpaceDimensionBoundsTest::RunTest(const FString& Parameters)
{
	...
	TestEqualExactFloat(TEXT("BoxSpaceDimension.High == 2.0"), BoxSpaceDimension.High, 3.0f);

    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionZeroOneUnitTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Zero One Unit Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionCenteredUnitTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Centered Unit Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionDenormalizeTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Denormalize Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FBoxSpaceDimensionDenormalizeTest::RunTest(const FString& Parameters)
{
    ...
    TestEqualExactFloat(TEXT("BoxSpaceDimension.RescaleValue(0.5) == 0.5"), BoxSpaceDimension.RescaleValue(0.5), 0);
    TestEqualExactFloat(TEXT("BoxSpaceDimension.RescaleValue(1) == 3.0"), BoxSpaceDimension.RescaleValue(1), 3.0);

    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionRescaleTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Rescale Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
...
bool FBoxSpaceDimensionRescaleTest::RunTest(const FString& Parameters)
{
    ...
    TestEqualExactFloat(TEXT("BoxSpaceDimension.RescaleValue(7.5, 10.0, 5.0) == 5.0"), BoxSpaceDimension.RescaleValue(7.5, 5, 10.0), 5.0);
    TestEqualExactFloat(TEXT("BoxSpaceDimension.RescaleValue(3.0, 5.0, 0.0) == 6.0"), BoxSpaceDimension.RescaleValue(3.0, 5.0, 0.0), 6.0);

    return true;
}

IMPLEMENT_SIMPLE_AUTOMATION_TEST(FBoxSpaceDimensionNormalizeTest, "Schola.Spaces.BoxSpace.BoxSpaceDimension.Normalize Test ", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ProductFilter)
